...
?>
    ...
    <div class="page-main-content">
        <div class="container-fluid p-5">
            ...
            <div class="bill bg-white rounded p-4 mx-auto" style="width: 60%">
                <div class="row bill_header_section_1 mb-3">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <span class="border-bottom border-dark">&nbsp;<?php echo esc_html($date); ?>&nbsp;</span>
                        <h4 class="d-inline-block">تاریخ</h4>
                    </div><!-- .col-lg-3 -->
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <h1 class="text-danger text-end">فہد سلطانی ٹریڈرز</h1>
                    </div><!-- .col-lg-9 -->
                </div><!-- .bill_header_section_1 -->

                <div class="row bill_header_section_2">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                ...
                <div class="bill_header_section_3 d-flex justify-content-between my-2">
                ...
                <div class="bill_footer">
                    <h3 class="bg-primary text-white text-center rounded w-100 py-2">دکان نمبر 46 نئی سبزی منڈی کاہنہ کچا فیروز پور روڈ لاہور</h3>
                </div><!-- .bill_footer -->
            </div><!-- .bill -->
